    ...
    <div class="container">
        ...
        <div class="introduce" id="info">
            ...
            <div class="content">
                <h3>GIỚI THIỆU</h3>
                <h2>FUWO</h2>
                <span>Fuwo là một sàn thương mại điện tử giúp mọi người có thể mua sắm bất cứ thứ gì một cách dễ dàng, nhanh chóng với chi phí cực kỳ rẻ.
                <br>
                FWC ra đời là nền tảng thương mại điện tử chuyên giải quyết hàng tồn kho cho các doanh nghiệp. Và cung cấp trải nghiệm mua hàng hoàn toàn mới cho người dùng khi chỉ trong 1 tài khoản.
                <br>
                Tầm nhìn: Đến năm 2025 trở thành top 3 trang thương mại điện tử lớn nhất Đông Nam Á.
                <br>
                Sứ mệnh: Giúp cho bất kỳ ai có thể mua sắm bất kỳ hàng hoá nào với chi phí rẻ nhất.
        ...
        <div class="roadmap" id="roadmap">
            ...
            <div class="content">
                <img src="/images/roadmap-TiengViet.jpg" alt="">
            </div>
        </div>
        <div class="system">
            <div class="title">
